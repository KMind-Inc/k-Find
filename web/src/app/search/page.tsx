...
export default function SearchPage() {
  ...
  useEffect(() => {
    ...
    const searchType = decodeURIComponent(searchParams.get("search_type") || "")
  ...
  return (
      <div id="searchresult" className="absolute inset-0">
        <div className="mx-auto max-w-3xl absolute inset-4 md:inset-8 bg-white">
          ...
          <div className="px-4 md:px-8 pt-6 pb-24 rounded-2xl h-full overflow-auto">
            <Title query={queryParams.query}></Title>
            <Result key={queryParams.rid} queryParams={queryParams} ></Result>
          </div>
